...
1. **Ambees** (ambees.io). An early-career recruiting platform I co-founded with my high school best friend, where I'm CTO. I built it full-stack with Next.js, React, Neon PostgreSQL, and Vercel. It has AI voice onboarding and multi-stage job matching using OpenAI Realtime, plus resumable application automation for Greenhouse, Lever, Ashby, and Workday using Playwright and Browserbase. We completed the Summer Launch Incubator (SLI), refining the product through customer discovery and venture mentorship.
...
- AI/ML: RAG, AI agents, OpenAI API (including Realtime), Gemini API, Groq API, PyTorch, NumPy, HuggingFace Transformers, llama.cpp, Jupyter.
...
- LLM Tutors for All, Data Discovery Program, UC Berkeley Data Science Undergraduate Studies (Sep 2026 to present, project lead Edwin Vargas Navarro). I benchmark course-deployed LLM tutors (Data 8, Data 100, E127) on mistake identification, answer withholding, and actionability, and I'm building a Python benchmark comparing providers, RAG vs. raw PDF context, PDF-to-Markdown conversion, and token cost.
...
- Research Assistant, UC Berkeley Department of Mathematics (Jan to May 2026, advisor Prof. Alan Hammond). I investigated Nash equilibria in Brownian Boost tug-of-war games with resource allocation dynamics, built the Trail of Lost Pennies game, and analyzed human play traces with ABMN equations.
- Data Discovery Program (Jan to May 2026, advisor Eric Van Dusen). I benchmarked small laptop-runnable models (Qwen, TinyLlama) with HuggingFace Transformers and llama.cpp, built Jupyter pipelines for accuracy, bias, and compute tradeoffs, and designed a RAG curriculum for a future Berkeley course.
